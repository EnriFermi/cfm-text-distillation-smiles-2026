...
RUN_DIR="$PROJECT_DIR/logs/train/tinystories_cfm_resume144001_to400k_nfe32_20260801_122502"
...
COMMAND=(
    ...
    experiment=cfm_tinystories_resume144k_to400k_nfe32
    logger=csv
...
printf '%s\n' "$TRAIN_PID" >"$PID_FILE"
{
    ...
    printf 'target_global_step=400000\n'
    printf 'requested_additional_global_steps=200000\n'
    printf 'actual_steps_from_recoverable_checkpoint=255999\n'
    printf 'checkpoint_cadence_steps=10000\n'
    printf 'command='
    printf '%q ' "${COMMAND[@]}"
    printf '\n'
